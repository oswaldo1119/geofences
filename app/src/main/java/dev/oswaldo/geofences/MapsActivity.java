...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    private void displayLocation() {
        ...
        if(mLastLocation != null){
            ...
            Log.e("EDMTDEV", "Can not get your location");
        }
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng daugerous_area = new LatLng(20.667928, -103.364843);
        mMap.addCircle(new CircleOptions()
                .center(daugerous_area)
                .radius(50) // in metters => 50 m
        ...
        //Add GeoQuery here
        // 0.5f = 0.5 km = 500 m
        GeoQuery geoQuery = geoFire.queryAtLocation(new GeoLocation(daugerous_area.latitude, daugerous_area.longitude), 0.05f);
        geoQuery.addGeoQueryEventListener(new GeoQueryEventListener() {
            ...
            public void onKeyMoved(String key, GeoLocation location) {
                Log.e("MOVE", String.format("%s moved within the dangerous area[%f/%f]", key,location.latitude, location.longitude));
            }
